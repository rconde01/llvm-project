...
C$ Restrictions
C
C     1)  The file, FNAME, must exist prior to calling TXTOPR.
C
C$ Literature_References
C
C     [1]  "Lahey F77L EM/32 FORTRAN Language Reference Manual", p.145.
C
C     [2]  "Language Reference Manual", Absoft Fortran V3.2, page 7-12
C          (for the NeXT), 1993.
C
...
C$ Version
C
C-    SPICELIB Version 2.27.0, 28-NOV-2021 (BVS)
C
C        Updated for MAC-OSX-M1-64BIT-CLANG_C.
C
C-    SPICELIB Version 2.26.0, 17-JUN-2021 (JDR)
C
